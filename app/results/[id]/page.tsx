        ...
        <section className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="mt-12 grid gap-12 md:grid-cols-2 md:divide-x md:divide-gray-300">
            <div className="text-center md:px-10">
              ...
              <button data-change-details={undefined} className="mt-8 rounded-md bg-primary px-10 py-3.5 text-lg font-medium text-white transition hover:bg-blue-600">
                {r.cta.leftButton}
              </button>
            </div>
            <div className="text-center md:px-10">
              ...
              <button data-change-details className="mt-8 rounded-md bg-primary px-10 py-3.5 text-lg font-medium text-white transition hover:bg-blue-600">
                {r.cta.rightButton}
              </button>
            </div>
          </div>
